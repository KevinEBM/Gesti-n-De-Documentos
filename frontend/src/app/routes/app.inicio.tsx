            ...
            <div className="space-y-4">
                ...
                <Card>
                    <CardHeader className="pb-3">
                        <CardTitle className="text-base">Acerca de SIGD Plantar S.A.S.</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="grid gap-5 sm:grid-cols-2 sm:gap-6">
                            <div className="space-y-1.5">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="text-sm font-semibold">¿Qué es SIGD Plantar S.A.S.?</h3>
                                </div>
                                <p className="text-sm leading-relaxed text-muted-foreground">
                                    SIGD (Sistema Integrado de Gestión Documental) es la plataforma interna de
