...
/**
 * Datos que envía el administrador para crear un subprograma: su
 * código, nombre, descripción opcional y a qué área pertenece.
 */
public record SubprogramaRequest(
